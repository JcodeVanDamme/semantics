package com.semantics.triplestore.parser;
...
public class ParserTest {
    ...
    void initTripleStore_ttl__withParser_init() {
        ParserTripleProvider provider = new ParserTripleProvider("src/test/java/com/semantics/triplestore/parser/test.ttl");
    ...
    void initTripleStore_nt__withParser_init() {
        ParserTripleProvider provider = new ParserTripleProvider("src/test/java/com/semantics/triplestore/parser/test.nt");
        TripleStore store = new TripleStore();
        provider.initTriples(store);
