...
public interface K2 {
     ...
     * @return true if the Cell contains a set Bit, otherwise false
     */
    boolean checkCell(int row, int col);

    /**
     * Returns all Column Indices within the specified Bounds whose Cells are set
     * in the given row.
     *
     * @param row Row Index
     * @param lColBound Lower Column Index Bound
     * @param uColBound Upper Column Index Bound
     * @return Indices of all Columns with a set Bit
     */
    ...
    /**
     * Returns the Column Indices of all set Cells in the specified row.
     *
     * @param row Row Index
     * @return  Indices of all Columns with a set Bit
     */
    ...
    /**
     * Returns all set Cells whose Column lies within the specified Bounds.
     *
     * @param lColBound Lower Column Index Bound
     * @param uColBound Upper Column Index Bound
